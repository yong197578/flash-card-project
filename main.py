...
try:
    ...
    original_data = pandas.read_csv("data/learn_python.csv")
    print(original_data)
...
def next_card():
    ...
    canvas.itemconfig(card_title, text="Terms", fill="black")
...
card_title = canvas.create_text(400, 100, text="", font=("Ariel", 30, "italic"))
card_word = canvas.create_text(400, 263, width=750, text="", font=("Ariel", 25, "bold"))
